...
upload_df_to_supabase(artists_df, "artists", supabase_url, supabase_key, supabase_db_url)
upload_df_to_supabase(albums_df, "albums", supabase_url, supabase_key, supabase_db_url)
upload_df_to_supabase(top_tracks_df, "tracks", supabase_url, supabase_key, supabase_db_url)
